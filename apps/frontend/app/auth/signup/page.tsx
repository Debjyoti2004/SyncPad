      ...
      <div className="w-full max-w-lg relative z-10">
        <div className="text-center mb-10">
          <h1 className="text-4xl font-bold text-white mb-3 tracking-tight">
            Join <span className="bg-gradient-to-r from-purple-400 to-blue-400 bg-clip-text text-transparent">SyncPad</span>
          </h1>
          <p className="text-slate-400 text-lg">
            Create your account and start collaborating with interactive whiteboards
          </p>
        </div>
        ...
        <div className="text-center mt-8">
          <p className="text-slate-500 text-xs leading-relaxed max-w-md mx-auto">
            By creating an account, you agree to SyncPad's{" "}
